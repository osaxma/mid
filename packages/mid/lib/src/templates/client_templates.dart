...
export 'package:mid_protocol/mid_protocol.dart' show Message, MessageType;
export 'package:mid_client/mid_client.dart' show HttpInterceptorClient, MessageInterceptorClient; 
...
String generateClientFileContents(List<ClientSource> sources, String projectName) {
  ...
  for (final src in sources) {
    ...
    final args = 'executeHttp, getStream';
